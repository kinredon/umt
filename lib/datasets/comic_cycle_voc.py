...
class comic_cycle_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'comic_cycle_voc_' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.COMIC_CYCLE_VOC#self._get_default_path() if devkit_path is None \
