...
class cityscape_car_cycle_sim10k(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'cityscape_car_cycle_sim10k_'+ image_set)
        self._year = 2007
        self._image_set = image_set
        self._devkit_path = cfg_d.CITYSCAPE_CAR_CYCLE_SIM10K#self._get_default_path() if devkit_path is None \
            #else devkit_path
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'cityscape_kitti', 'Main')
