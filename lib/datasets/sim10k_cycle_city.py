...
class sim10k_cycle_city(imdb):
    def __init__(self, image_set,  devkit_path=None):
        imdb.__init__(self, 'sim10k_cycle_city_'+ image_set)
        self._year = 2007
        self._image_set = image_set
        self._devkit_path = cfg_d.SIM10K_CYCLE_CITY#self._get_default_path() if devkit_path is None \
            #else devkit_path
