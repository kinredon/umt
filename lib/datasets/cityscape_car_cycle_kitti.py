...
class cityscape_car_cycle_kitti(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'cityscape_car_cycle_kitti_'+ image_set)
        self._year = 2007
        self._image_set = image_set
        self._devkit_path = cfg_d.CITYSCAPE_CAR_CYCLE_KITTI#self._get_default_path() if devkit_path is None \
            #else devkit_path
