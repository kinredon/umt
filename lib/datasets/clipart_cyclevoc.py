...
class clipart_cyclevoc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'clipart_cyclevoc_' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.CLIPART_CYCLEVOC#self._get_default_path() if devkit_path is None \
