...
def parse_args():
    ...
    parser.add_argument('--load_name', dest='load_name',
                        ...
                        type=str)
    parser.add_argument('--student_load_name', dest='student_load_name',
                        help='path to load student models', default="models",
                        type=str)
    parser.add_argument('--teacher_load_name', dest='teacher_load_name',
                        help='path to load teacher models', default="models",
                        type=str)
    ...
    parser.add_argument('--lam', dest='lam',
                        help='trade-off parameter between pseudo loss and other loss.',
                        default=0.1, type=float)
    parser.add_argument('--pe', dest='pretrained_epoch',
                        help='Which epoch pseudo label start to work',
                        default=0, type=float)
    parser.add_argument('--pl', dest='pl',
                        help='whether use pseudo label',
                        action='store_true')
    parser.add_argument('--mt', dest='mt',
                        help='whether use mean teacher or not',
                        action='store_true')
    parser.add_argument('--st', dest='style_transfer',
                        help='whether use style transfer or not',
                        action='store_true')
    parser.add_argument('--aug', dest='aug',
                        help='whether use data augmentation or not',
                        action='store_true')
    parser.add_argument('--fake_s', dest='fake_s',
                        help='whether use fake_s as input for teacher network or not',
                        action='store_true')
    ...
    parser.add_argument('--image_dir', dest='image_dir',
                        ...
                        default="images")
    parser.add_argument('--teacher_alpha', dest='teacher_alpha',
                        help='Teacher EMA alpha (decay)',
                        default=0.99, type=float)
    parser.add_argument('--bin', dest='binary',
                        help='whether use binary',
                        action='store_true')
    parser.add_argument('--vis', dest='vis',
                        help='switch to visual mode',
                        action='store_true')
...
def set_dataset_args(args, test=False):
    if not test:
        if args.dataset == "pascal_voc":
            ...
            args.imdbval_name = "voc_2007_test"
            args.imdb_name_fake_target = "voc_cycleclipart_2007_trainval+voc_cycleclipart_2012_trainval"
