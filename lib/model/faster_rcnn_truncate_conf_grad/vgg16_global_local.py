...
from model.faster_rcnn_truncate_conf_grad.faster_rcnn_global_local_self_ensemble import _fasterRCNN
...
class vgg16(_fasterRCNN):
    def __init__(
        ...
        _fasterRCNN.__init__(self, classes, class_agnostic, self.lc, self.gc, self.dc, conf)
