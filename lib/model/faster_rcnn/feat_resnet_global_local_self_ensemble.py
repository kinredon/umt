...
from model.faster_rcnn.feat_faster_rcnn_global_local_self_ensemble import _fasterRCNN
...
class resnet(_fasterRCNN):
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False, lc=False, gc=False, dc=None,
                 conf=None):
        self.model_path = cfg.RESNET101_PATH
        ...
        _fasterRCNN.__init__(self, classes, class_agnostic, lc, gc, dc, conf)
    ...
    def _init_modules(self):
        ...
        self.netD_dc = netD(context=False)  # vanilla dc
